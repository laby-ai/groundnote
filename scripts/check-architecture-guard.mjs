...
const watchedFiles = [
  ...
  { file: 'src/components/studio/PresentationPanels.tsx', maxLines: 820, target: 'keep this as the image PPT panel and mode shell; move structured generation elsewhere' },

...
const papers: RagSourceInput[] = [
  {
    ...
    fileType: 'txt',
    content: '资料地图需要围绕核心词建立节点、关系、引用状态和后续问题。',
    rawContent: '资料地图需要围绕核心词建立节点、关系、引用状态和后续问题。',
  },
];
...
const citations: GroundedCitation[] = [
  {
    ...
    chunkIndex: 0,
    sourceTitle: '资料地图可用性验证',
    excerpt: '资料地图需要围绕核心词建立节点、关系、引用状态和后续问题。',
    score: 0.92,
  },
  {
    paperId: 'paper-map-1',
...
assert.ok(map.title.includes('资料地图'), 'title should be product-facing');
